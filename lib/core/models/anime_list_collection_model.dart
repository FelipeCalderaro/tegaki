...
AnimeListCollection animeListCollectionFromJson(String str) =>
    AnimeListCollection.fromJson(json.decode(str));

String animeListCollectionToJson(AnimeListCollection data) =>
    json.encode(data.toJson());

class AnimeListCollection {
  AnimeListCollection({
  ...
  factory AnimeListCollection.fromJson(Map<String, dynamic> json) =>
      AnimeListCollection(
        mediaListCollection:
