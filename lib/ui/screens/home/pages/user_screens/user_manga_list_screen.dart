    ...
    return Padding(
      ...
      child: Column(
        ...
        children: List.generate(
          userBloc.mangaList.mediaListCollection.lists.length,
          (index) => Column(
            children: [
              Container(
                ...
                child: Text(
                  userBloc.mangaList.mediaListCollection.lists[index].name,
              ...
              GridView.count(
                ...
                children: List.generate(
                  userBloc.mangaList.mediaListCollection.lists[index].entries
                      .length,
                  (entriesIndex) => Container(
                    ...
                    child: ImageCard(
                      ...
                      imageUrl: userBloc
                          ...
                          .coverImage
                          .extraLarge,
                      title: userBloc.mangaList.mediaListCollection.lists[index]
                      ...
                      onTap: () => Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => InfoScreen(
                            id: userBloc.mangaList.mediaListCollection
